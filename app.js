...
app.get('/left', homeController.getLeft);
app.get('/right', homeController.getRight);
app.get('/control', homeController.getControl);

app.post('/right_blink/:val',homeController.blink_right);
